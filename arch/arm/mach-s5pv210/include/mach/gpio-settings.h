...
static unsigned int sleep_alive_gpio_table[][4] =
{
	...
	{S5PV210_GPH0(5), S3C_GPIO_INPUT, S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_BUCK_2_EN
#else
...
#if defined(CONFIG_SAMSUNG_FASCINATE)
	{S5PV210_GPH3(4), S3C_GPIO_INPUT,  S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN},	//GPIO_KBR4
#endif
#if defined (CONFIG_SAMSUNG_CAPTIVATE)
  	...
  	{S5PV210_GPH3(7), S3C_GPIO_INPUT,	S3C_GPIO_SETPIN_NONE, S3C_GPIO_PULL_DOWN}, //GPIO_CP_RST
#else //CONFIG_SAMSUNG_VIBRANT CONFIG_SAMSUNG_GALAXYS
